...
import de.leancoders.magento.client.models.MagentoAttribute;
...
public class ProductAttributeValueDeserializer implements ObjectDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser parser, Type type, Object o) {
        ...
        if (obj instanceof final JSONArray ja) {
            for (int i = 0; i < ja.size(); ++i) {
                Object jaObj = ja.get(i);
                if (jaObj instanceof final JSONObject jasObj) {
        ...
        else if (obj instanceof final JSONObject jo) {
